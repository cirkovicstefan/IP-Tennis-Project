...
?>
        ...
        <div class="container" style="background-color:#ffffff;">
            <a class="btn btn-secondary mt-5 mx-2 float-right" href="formaInsertIgraci.php">Dodaj igraca</a>
            <div class="row">
                <?php
                        ...
                        <tbody>
                            <?php foreach ($igraci as $item) : ?>
                                <tr>
                                    ...
                                    <td><?= $item['porazi'] ?></td>
                                    <td><?= $item['email'] ?></td>
                                    <td><a class="btn btn-danger btn-sm" href="../controller-admin/Igraci.php?action=delete&id=<?= $item['id'] ?>">IZBRIŠI IGRACA</a></td>
                                    <td><a class="btn btn-primary btn-sm" href="../controller-admin/Igraci.php?action=edit&id=<?= $item['id'] ?>">IZMENI IGRACA</a></td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>

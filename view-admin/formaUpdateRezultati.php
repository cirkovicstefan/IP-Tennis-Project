...
?>
        ...
        <div class="container">
            <div class="row mt-4" style="width: 45%;margin-left:auto;margin-right:auto">
                <div class="col-md-12">
                    <form id="formRezultat" action="../controller-admin/Rezultati.php?action=update" method="post" class="border rounded p-5">
                        ...
                        <div class="mb-3 form-check">
                            ...
                            <input type="checkbox" checked class="form-check-input" id="" name="potvrda_rezultata" 
                                <?php

...
?>
  ...
  <div class="container">
    <div class="row mt-4" style="width: 40%;margin-left:auto;margin-right:auto">
      <div class="col-md-12">
        <form id="formTeren" action="../controller-admin/Tereni.php?action=update" method="post" class="border rounded p-5">
          <div class="mb-3">
          ...
          <div class="mb-3 form-check">
            ...
            <input type="checkbox"  class="form-check-input" id="exampleCheck1" name="zauzet"
            <?php

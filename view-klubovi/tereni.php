                        ...
                        <tbody>
                            ...
                            <?php foreach ($tereni as $item) : ?>
                                <tr>
                                    ...
                                    <td><a class="btn btn-danger btn-sm" href="../controller-klubovi/controllerTeren.php?action=delete&id=<?= $item['id'] ?>">IZBRIŠI</a></td>
                                    <td><a class="btn btn-primary btn-sm" href="../controller-klubovi/controllerTeren.php?action=edit&id=<?= $item['id'] ?>">IZMENI</a></td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
